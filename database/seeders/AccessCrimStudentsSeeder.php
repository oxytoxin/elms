...
class AccessCrimStudentsSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $this->encodeCSV('csvs/masterlist/access/crimjustice.csv', 1);
    }
    ...
    {
        if (str_contains($dep, 'BSISM')) return 8;
        if (str_contains($dep, 'Criminology')) return 7;
    }
}
