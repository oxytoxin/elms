<div class="sticky top-0 flex flex-col text-gray-300 root">
    <div class="flex items-center justify-center h-12 p-1 border-b border-white bg-primary-500 banner">
        ...
        <h1 class="text-lg font-semibold text-white">SKSU-ELMS</h1>
    </div>
    <div class="flex justify-center py-4 mx-2 border-b border-white profile">
        <div class="avatar h-11"><img src="{{ asset('img/avatar.jpg') }}" class="object-cover h-full rounded-full" alt="avatar"></div>
        <div class="ml-3">
            <h1>John Doe</h1>
    ...
    <div class="p-2 mt-3">
        ...
        <div class="actions">
            <a href="{{ route('student.home') }}" class="flex items-center p-2 bg-opacity-25 rounded-md hover:bg-gray-400 item">
                <i class="mr-2 icofont-home"></i>
                <h1 class="text-sm font-semibold">Home</h1>
            </a>
            <a href="{{ route('student.modules') }}" class="flex items-center p-2 bg-opacity-25 rounded-md hover:bg-gray-400 item">
