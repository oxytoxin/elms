<div class="relative flex flex-col min-h-screen">
    <div class="relative z-20 flex flex-col flex-1">
        ...
        <div class="flex flex-col flex-1 p-3 font-semibold bg-opacity-75 links bg-primary-600">
        ...
        <div class="actions">
            ...
            {{-- <a href="{{ route('teacher.calendar') }}" class="flex {{ strpos(url()->current(),'calendar') ? 'bg-gray-400' : '' }} items-center p-2 bg-opacity-75 rounded-md hover:bg-gray-400 item"> --}}
