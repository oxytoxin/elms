<div class="relative flex flex-col min-h-screen">
    <div class="relative z-20 flex flex-col flex-1 h-0 overflow-y-auto">
        ...
        <div class="flex flex-col flex-1 p-3 overflow-y-auto font-semibold bg-opacity-75 links bg-primary-600">
            <h1 class="text-sm font-semibold">Teacher</h1>
            <div class="actions">
                <a href="{{ route('teacher.home') }}" class="flex {{ strpos(url()->current(), 'home') ? 'bg-gray-400' : '' }} items-center p-2 bg-opacity-75 rounded-md hover:bg-gray-400 item">
                    <i class="mr-2 icofont-home"></i>
                    <h1 class="text-sm font-semibold">Home</h1>
                </a>
                <a href="{{ route('teacher.faculty_workload') }}" class="flex {{ strpos(url()->current(), 'my-workload') ? 'bg-gray-400' : '' }} items-center p-2 bg-opacity-75 rounded-md hover:bg-gray-400 item">
                    <i class="mr-2 icofont-tasks"></i>
                    <h1 class="text-sm font-semibold">My Workload</h1>
                </a>
                <a href="{{ route('teacher.modules') }}" class="flex {{ strpos(url()->current(), 'modules') ? 'bg-gray-400' : '' }} items-center p-2 bg-opacity-75 rounded-md hover:bg-gray-400 item">
                ...
                <a href="{{ route('teacher.gradebook') }}" data-turbolinks="false" class=" flex {{ strpos(url()->current(), 'gradebook') ? 'bg-gray-400' : '' }} items-center p-2 bg-opacity-75 rounded-md hover:bg-gray-400 item">
