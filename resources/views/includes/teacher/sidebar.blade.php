    ...
    <div class="relative z-20 flex flex-col flex-1 h-0 overflow-y-auto">
        ...
        <div class="flex flex-col flex-1 p-3 overflow-y-auto font-semibold bg-opacity-75 links bg-primary-600">
            ...
            <div class="actions">
                ...
                <a href="{{ route('teacher.calendar') }}" data-turbolinks="false"
                    ...
                    <a href="{{ route('teacher.gradebook') }}"
                        class="flex {{ strpos(url()->current(), 'gradebook') ? 'bg-gray-400' : '' }} items-center p-2 bg-opacity-75 rounded-md hover:bg-gray-400 item">
            ...
            <div class="actions">
                <a href="{{ route('teacher.tasks', ['task_type' => 1]) }}"
                ...
                <a href="{{ route('teacher.tasks', ['task_type' => 2]) }}"
                ...
                <a href="{{ route('teacher.tasks', ['task_type' => 3]) }}"
                ...
                <a href="{{ route('teacher.tasks', ['task_type' => 4]) }}"
        ...
        ->isProgramHead())
                <div class="actions">
                    <a href="{{ route('head.home') }}"
                        class="flex items-center p-2 bg-opacity-75 rounded-md hover:bg-gray-400 item">
