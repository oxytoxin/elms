<div>
    ...
    <div class="flex items-center mt-5 space-x-2 text-xl">
        ...
        <div class="space-x-2 text-sm">
            ...
            <span wire:click="filterToGrade" class="px-2 font-semibold {{ $filter=="toGrade" ? "bg-green-500" : "bg-green-300" }} rounded-lg cursor-pointer hover:bg-green-600 hover:text-white">TO GRADE</span>
                    ...
                    <div class="flex justify-center p-3 text-xs font-semibold uppercase">
                         <div class="flex items-center space-x-2">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-current" viewBox="0 0 60 60">
                                ...
                                <path d="M18.75 22.5h7.5v7.5h-7.5zM30 22.5h7.5v7.5h-7.5zM41.25 22.5h7.5v7.5h-7.5zM7.5 45h7.5v7.5h-7.5zM18.75 45h7.5v7.5h-7.5zM30 45h7.5v7.5h-7.5zM18.75 33.75h7.5v7.5h-7.5zM30 33.75h7.5v7.5h-7.5zM41.25 33.75h7.5v7.5h-7.5zM7.5 33.75h7.5v7.5h-7.5zM48.75 0v3.75h-7.5v-3.75h-26.25v3.75h-7.5v-3.75h-7.5v60h56.25v-60h-7.5zM52.5 56.25h-48.75v-41.25h48.75v41.25z"></path>
                            </svg>
                            <div>
    ...
    <div class="flex flex-col mt-5 space-y-2">
        @forelse ($tasks as $task)
        <a href="{{ route('teacher.task',['task'=> $task->id]) }}">
            <div class="flex items-center justify-between p-3 hover:bg-green-400 rounded-md  {{ $task->deadline < now() ? "bg-red-400" :  ($loop->iteration%2 ? "bg-green-300" : "bg-green-200") }}">
                <div class="flex items-center space-x-2">
