<div class="px-5">
    ...
    <h1 class="mt-2 font-bold">Course Module List for this section</h1>
    <div class="italic text-green-400">
    ...
    <table class="table min-w-full border-2 border-collapse border-gray-200 divide-y shadow">
        ...
        <tbody class="text-center divide-y-2">
            ...
            <tr class="divide-x">
                <td><a href="{{ route('teacher.module',['module' => $course_module->id]) }}" class="hover:text-primary-500">{{ $course_module->name }}</a></td>
                <td>{{ $course_module->files->count() }}</td>
