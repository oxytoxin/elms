                    ...
                    <div class="flex justify-center p-3 text-xs font-semibold uppercase">
                         <div class="flex items-center space-x-2">
                            ...
                            <div>
                                ...
                                <h1>Status: {{ $task->students()->where('student_id',auth()->user()->student->id)->first()->pivot->isGraded ? "Graded - Score: ". $task->students()->where('student_id',auth()->user()->student->id)->first()->pivot->score ."/".$task->max_score : "Not Yet Graded" }}</h1>
                                @else
