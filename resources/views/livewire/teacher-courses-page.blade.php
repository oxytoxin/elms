    ...
    <div class="w-full">
        ...
        <div class="mt-2">
            <form action="#">
                ...
                <textarea wire:model.lazy="description" class="flex-1 w-full resize form-textarea" rows="4" autocomplete="off" placeholder="Resource Description" autofocus name="description"></textarea>
                @error('description')
                <h1 class="text-xs italic font-semibold text-red-600">{{ $message }}</h1>
                @enderror
                <div class="flex flex-col items-center mt-2 md:flex-row">
                    ...
                    <button wire:click="addResources" wire:loading.remove wire:target="resources" class="w-full p-2 mt-2 text-white whitespace-no-wrap rounded-lg md:w-auto md:ml-2 md:mt-0 hover:text-black focus:outline-none bg-primary-500">Upload
                        Resource</button>
                </div>
                @error('resources.*')
                <h1 class="text-xs italic font-semibold text-red-600">{{ $message }}</h1>
