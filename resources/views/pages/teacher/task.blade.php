                ...
                <table class="min-w-full leading-normal">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                                <p class="text-gray-900 whitespace-nowrap">IT</p>
                            </td>
                            <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                                <p class="text-gray-900 whitespace-nowrap">
                                    Jan 21, 2020
                            ...
                            <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                                <a href="#"><span class="relative inline-block px-3 py-1 font-semibold leading-tight text-green-900 hover:bg-primary-500">
