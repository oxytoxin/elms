...
<div>
    ...
    @if ($section->videoroom)
        <a href="{{ route('student.meeting',['room' => $section->videoroom->code, 'section_id' => $section->id]) }}" class="inline-block p-2 border-2 border-white rounded-lg hover:bg-primary-600">JOIN MEETING</a>
    @endif
    </h1>
