...
<main class="p-3">
    ...
    <div class="flex min-h-screen">
        <div class="w-5/6 m-4">
            <h1 class="p-2 font-semibold">MODULES MANAGER</h1>
            <div class="grid grid-cols-4 gap-2 p-2">
                <div class="w-full overflow-hidden h-72">
                    ...
                    <div class="h-2/12"><a href="#" class="flex items-center justify-center w-full h-full p-1 text-white hover:text-black bg-primary-600">View Module</a></div>
                </div>
            </div>
        </div>
