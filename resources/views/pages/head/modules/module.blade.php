        ...
        <div class="flex min-h-screen">
            <div class="w-5/6 p-2 m-4">
                ...
                <div class="flex items-center my-2">
                    <a href="#" target="_blank"><h1 class="italic underline text-primary-600">Module1Week1.pdf</h1></a>
                    <a href="/" target="_blank" rel="noopener noreferrer" class="px-2 ml-3 text-white border hover:text-black border-primary-600 bg-primary-500">Preview</a>
                </div>
                <div class="flex items-center my-2">
                    <a href="#" target="_blank"><h1 class="italic underline text-primary-600">Module1Week1.pptx</h1></a>
                    <a href="/" target="_blank" rel="noopener noreferrer" class="px-2 ml-3 text-white border hover:text-black border-primary-600 bg-primary-500">Preview</a>
                </div>
